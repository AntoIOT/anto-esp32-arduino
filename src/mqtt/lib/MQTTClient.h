...
namespace MQTT
{
    ...
    class Client
    {
        ...
        public:
             ...
             *  client_yield can be called if no other MQTT operation is needed.
             ...
             */
            int client_yield(unsigned long timeout_ms = 1000L);
...
int MQTT::Client<Network, Timer, a, MAX_MESSAGE_HANDLERS>::deliverMessage(MQTTString& topicName, Message& message)
{
    ...
    template<class Network, class Timer, int a, int b>
int MQTT::Client<Network, Timer, a, b>::client_yield(unsigned long timeout_ms)
{
    int rc = SUCCESS;
    Timer timer = Timer();
